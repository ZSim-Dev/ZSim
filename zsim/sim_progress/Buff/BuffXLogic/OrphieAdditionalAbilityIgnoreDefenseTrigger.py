...
class OrphieAdditionalAbilityIgnoreDefenseTriggerRecord(BRBC):
    def __init__(self):
        super().__init__()
        self.buff_index = "Buff-角色-奥菲斯-额外能力-准星聚焦无视防御力"


class OrphieAdditionalAbilityIgnoreDefenseTrigger(Buff.BuffLogic):
    def __init__(self, buff_instance):
        """这是奥菲斯额外能力准星聚焦无视防御触发器Buff的脚本"""
    ...
    def check_record_module(self):
        ...
        if self.buff_0.history.record is None:
            self.buff_0.history.record = OrphieAdditionalAbilityIgnoreDefenseTriggerRecord()
    ...
    def special_hit_logic(self, **kwargs):
        ...
        beneficiary_name_list: list[str] = [
            obj.NAME
            for obj in sim_instance.char_data.char_obj_list
            if obj.CID in beneficiary_cid_list
        ]
