...
class OrphieCoreSkillAtkBonusRecord(BRBC):
    def __init__(self):
        super().__init__()


class OrphieCoreSkillAtkBonus(Buff.BuffLogic):
    def __init__(self, buff_instance):
        """这是奥菲斯核心被动准星聚焦攻击力Buff的脚本"""
    ...
    def check_record_module(self):
        ...
        if self.buff_0.history.record is None:
            self.buff_0.history.record = OrphieCoreSkillAtkBonusRecord()
