...
class SeedAdditionalAbilitySNAAndQBonusRecord(BRBC):
    def __init__(self):
        super().__init__()


class SeedAdditionalAbilitySNAAndQBonus(Buff.BuffLogic):
    ...
    def check_record_module(self):
        ...
        if self.buff_0.history.record is None:
            self.buff_0.history.record = SeedAdditionalAbilitySNAAndQBonusRecord()
