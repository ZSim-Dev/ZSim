...
class SeedCinema2SpConsumeTransDmgBonusRecord(BRBC):
    def __init__(self):
        super().__init__()


class SeedCinema2SpConsumeTransDmgBonus(Buff.BuffLogic):
    ...
    def check_record_module(self):
        ...
        if self.buff_0.history.record is None:
            self.buff_0.history.record = SeedCinema2SpConsumeTransDmgBonusRecord()
