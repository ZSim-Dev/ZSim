# 这是席德4画喧响效率与大招增伤Buff的脚本
from .. import Buff, JudgeTools, check_preparation
from ._buff_record_base_class import BuffRecordBaseClass as BRBC


class SeedCinema4DecibelGainAndQDMGBonusRecord(BRBC):
    def __init__(self):
        super().__init__()


class SeedCinema4DecibelGainAndQDMGBonus(Buff.BuffLogic):
    ...
    def check_record_module(self):
        ...
        if self.buff_0.history.record is None:
            self.buff_0.history.record = SeedCinema4DecibelGainAndQDMGBonusRecord()
